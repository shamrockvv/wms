...
class FlatUI3 extends CApplicationComponent {
	...
	public function registerOther() {
		...
		$cs->registerScriptFile($this->getAssetsUrl() . '/js/respond.min.js', CClientScript::POS_HEAD, array('media' => 'lte IE 9'));
...
//		$cs->registerScriptFile($this->getAssetsUrl() . '/js/icon-font-ie7.js', CClientScript::POS_HEAD, array('media' => 'lte IE 7'));
	...
	protected function registerJS($position = CClientScript::POS_HEAD) {
		...
		$cs->registerScriptFile($this->getAssetsUrl() . '/js/holder.js', CClientScript::POS_END);
		$cs->registerScriptFile($this->getAssetsUrl() . '/js/flatui-fileinput.js', CClientScript::POS_END);
		...
		$cs->registerScriptFile($this->getAssetsUrl() . '/js/jquery.typeahead.js', CClientScript::POS_END);
	...
	protected function getAssetsUrl() {
		if (isset($this->_assetsUrl))
			...
			$assetsPath = Yii::getPathOfAlias('flatui3.assets');
