...
function Swipe(container, options) {
	...
	$("#slider").css('height', $("#wrap" + index).height());
	$("li").siblings().css("color", "#3E5D9E").css('font-weight', 'normal').css('text-decoration', 'none');
	$(".move" + index).css("color", "#535353").css('font-weight', 'bold').css('text-decoration', 'underline');
